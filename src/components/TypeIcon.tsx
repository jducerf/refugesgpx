import { Banknote, Bed, BedDouble, Bus, Cross, Droplets, Home, Mountain, ShoppingBag, Tent, Toilet, TrainFront, TriangleAlert, Waves, type LucideIcon } from 'lucide-react';
